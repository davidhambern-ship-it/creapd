...
// Each scene has:
//   text    — what appears on screen (always spells CREAPD correctly)
//   speech  — what the TTS engine reads aloud (uses "Creeped" for correct pronunciation)
export const NARRATION_ROUTES = {
  ...
  '/': {
    ...
    scenes: [
      {
        id: 'dashboard-intro',
        text: 'This is your production dashboard. CREAPD pulls stories from your sources and organizes them here.',
        speech: 'This is your production dashboard. Creeped pulls stories from your sources and organizes them here.',
        visual: 'persona',
      },
      {
        ...
        speech: 'Each story is scored and filtered to match your show profile. The ones with the highest fit scores rise to the top.',
        visual: 'pipeline',
      },
      {
        id: 'dashboard-action',
        text: 'Approve stories to move them into production, or let me handle it in AUTOPILOT. Your call.',
        speech: 'Approve stories to move them into production, or let me handle it in AUTOPILOT. Your call.',
        visual: 'reveal',
      },
    ],
  },
