...
const QUICK_ACTIONS = [
  { icon: Clock, label: 'Continue Last Production', path: '/news/productionpackages', color: 'text-berna-orange', bg: 'bg-berna-orange/10' },
  ...
  { icon: Layers, label: 'Open Story Manager', path: '/news/storymanager', color: 'text-berna-purple', bg: 'bg-berna-purple/10' },
];
