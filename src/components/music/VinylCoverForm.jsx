      ...
      >
        ...
        {room === 'identity' && (
          ...
          >
            ...
            {/* Broadcast — positioned over the bottom rectangle on the album cover */}
            <CoverZone
              label="Broadcast"
              accent={accent}
              glow={false}
              style={{ bottom: '8%', left: '8%', right: '38%' }}
            >
            ...
            <CoverZone
              ...
              label="Host"
              accent={accent}
              style={{ gridRow: '2', gridColumn: '1', maxWidth: '68%', marginLeft: '14%', marginTop: '1%' }}
            >
            ...
            <CoverZone
              ...
              label="Liner Notes"
              accent={accent}
              style={{ gridRow: '3', gridColumn: '1', maxWidth: '68%', marginLeft: '14%', marginTop: '1%' }}
            >
