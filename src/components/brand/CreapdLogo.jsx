      ...
      {showWordmark && (
        <div className="flex flex-col leading-none">
          ...
          >
            ...
            <span style={metallicStyle}>PD</span>
          </div>
          ...
          >
            ...
            <span style={{ color: '#8A2BE2' }}>AUTOMATE.</span>
            <span style={{ color: '#00CED1' }}>PRODUCE.</span>
            <span style={{ color: '#FFFFFF' }}>DIRECT.</span>
          </div>

          {/* Tagline row 2 */}
          <div
            className="text-[5px] lg:text-[6px] text-white/60 tracking-[0.2em] font-medium mt-px"
