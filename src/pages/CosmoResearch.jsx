...
export default function CosmoResearch() {
  const { config, research, loading } = useCosmoProduction();
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Background research on beauty trends, wellness, ingredients, and techniques</p>
      </div>
