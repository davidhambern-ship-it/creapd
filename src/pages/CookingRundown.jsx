...
import { formatRuntime, SEGMENT_TYPE_LABELS } from '@/lib/cookingConstants';
import { Loader2, ChefHat, ClipboardList, AlertCircle, Clock } from 'lucide-react';

export default function CookingRundown() {
  const { config, segments, loading } = useCookingProduction();
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Structured show timeline with cooking segments and timings</p>
      </div>
