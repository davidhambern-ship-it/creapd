      ...
      <div className="relative z-10 config-scroll h-screen overflow-y-auto pb-32">
        ...
        <div className="px-4 pt-8 pb-6 max-w-5xl mx-auto">
          ...
          >
            ...
            <h1 className="text-7xl font-bold mb-1 bg-gradient-to-r from-fuchsia-500 via-purple-500 to-cyan-400 bg-clip-text text-transparent" style={{ fontFamily: "'Boxpot', sans-serif" }}>Discovery Room</h1>
