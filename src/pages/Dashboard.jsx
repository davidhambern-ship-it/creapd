        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="glass-panel p-5 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Link to="/news/archive" className="flex items-center gap-3 p-2 rounded-lg bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.04] transition-all group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="glass-panel p-5 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/news/automation" className="text-[10px] text-berna-purple hover:text-berna-purple/80">View All</Link>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="glass-panel p-5 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/news/production" className="text-[10px] text-berna-purple hover:text-berna-purple/80">View All</Link>
          </div>
          ...
          <div className="space-y-3">
              ...
              return (
                <Link key={pkg.id} to="/news/production" className="block p-3 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] border border-white/[0.04] transition-all">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="space-y-1.5">
                  {favBrands.map((brand) =>
                <Link key={brand.id} to="/news/brands" className="flex items-center gap-2 p-2 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] transition-colors group">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                  {favShows.map((show) =>
                <Link key={show.id} to="/news/shows" className="flex items-center gap-2 p-2 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] transition-colors group">
                      <Heart className="w-3 h-3 text-berna-orange fill-berna-orange flex-shrink-0" />
        ...
        <div className="glass-panel p-5 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/news/export" className="text-[10px] text-berna-purple hover:text-berna-purple/80">View All</Link>
          </div>
