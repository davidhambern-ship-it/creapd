...
import { formatRuntime, SEGMENT_TYPE_LABELS } from '@/lib/cosmoConstants';
import { Loader2, Sparkles, ClipboardList, AlertCircle, Clock } from 'lucide-react';

export default function CosmoRundown() {
  const { config, segments, loading } = useCosmoProduction();
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Structured show timeline with tutorials, demos, and timings</p>
      </div>
