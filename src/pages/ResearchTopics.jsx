...
import { Loader2, FlaskConical, PanelRightOpen, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';
import ResearchProgressModal from '@/components/research/ResearchProgressModal';
import TopicCreationPanel from '@/components/research/TopicCreationPanel';
    ...
    return (
      <div className="flex items-center justify-center h-full p-6">
        <div className="max-w-md text-center cc-animate-fade-up">
          ...
          <p className="text-muted-foreground mb-4">You need a research production configuration before creating topics.</p>
          <Button asChild>
  ...
  return (
    <div className="flex h-full overflow-hidden relative flex-col">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden relative">
        {/* Main: Topic creation form */}
        <div className="flex-1 min-w-0 relative overflow-hidden">
          <TopicCreationPanel config={config} onCreated={refresh} />
        </div>
