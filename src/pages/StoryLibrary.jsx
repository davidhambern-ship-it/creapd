    ...
    <div className="p-4 lg:p-6 max-w-5xl mx-auto space-y-4">
      ...
      {filtered.length === 0 ? (
        <div className="glass-panel p-12 text-center">
          ...
          {articles.length === 0 && (
            <Link to="/news/queue" className="inline-block mt-4">
              ...
              <div key={a.id} className="glass-panel p-4 hover:border-white/[0.12] transition-colors">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex flex-col gap-1 flex-shrink-0">
                    ...
                    <Link to="/news/workspace" className="text-berna-emerald hover:text-berna-emerald/80 p-1" title="Send to Manager">
