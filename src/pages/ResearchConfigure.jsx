              ...
              {RESEARCH_DEPTH_OPTIONS.map(opt => (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-lg border transition-all ${
                    config.research_depth === opt.value
        ...
        return (
          <div className="space-y-6">
            <div className="glass-panel p-5">
              <h3 className="font-heading font-semibold mb-3">Production Details</h3>
            ...
            <div className="glass-panel p-5">
              <h3 className="font-heading font-semibold mb-3">Research Settings</h3>
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto p-6 md:p-10">
        <div className="!flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-heading font-bold">Research Production Configuration</h1>
        ...
        <div className="!flex items-center justify-between">
          ...
          {step < STEPS.length - 1 ? (
            ...
            <Button onClick={handleSave} size="lg" disabled={!canProceed()}>
