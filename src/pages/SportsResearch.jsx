...
import { Loader2, Trophy, Search, AlertCircle } from 'lucide-react';

export default function SportsResearch() {
  const { config, research, loading } = useSportsProduction();
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Background research on sports, games, players, and trends</p>
      </div>
