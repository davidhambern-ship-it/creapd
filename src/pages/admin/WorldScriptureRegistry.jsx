...
export default function WorldScriptureRegistry() {
  ...
  const stats = {
    ...
    licenseRequired: records.filter(r => r.access_status === 'license_required').length,
    permissionRequired: records.filter(r => r.access_status === 'permission_required').length,
    copyrighted: records.filter(r => r.copyright_status === 'copyrighted').length,
